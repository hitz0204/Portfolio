...
let w1 = document.getElementById("heroCanvas").offsetWidth
let h1 = document.getElementById("heroCanvas").offsetHeight
...
let element = document.getElementById("heroCanvas")

function draw() {
  window.addEventListener("resize", windowResize());
  function windowResize(){
  w1 = document.getElementById("heroCanvas").offsetWidth
  h1 = document.getElementById("heroCanvas").offsetHeight
  resizeCanvas(w1, h1);
  }
